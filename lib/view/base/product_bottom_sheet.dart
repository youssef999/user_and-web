...
import 'package:efood_multivendor/view/screens/home/product_details.dart';
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    InkWell(
                      child: InkWell(
                        ...
                        onTap:(){
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => ProductDetails(img:'${widget.isCampaign ? Get.find<SplashController>().configModel.baseUrls.campaignImageUrl
                                : Get.find<SplashController>().configModel.baseUrls.productImageUrl}/${widget.product.image}')),
                          );
                ...
                (!widget.product.scheduleOrder && !_isAvailable) ? SizedBox() : Row(children: [
                  ...
                  Expanded(child: CustomButton(
                    ...
                    buttonText: widget.isCampaign ? 'order_now'.tr : fromCart ? 'update_in_cart'.tr : 'add_to_cart'.tr,
                    onPressed: () {
                      Get.back();
